        ...
        try:
            ...
            with open(file, 'r') as emp:
                for line in emp:
                    ...
                    print("Hello producer",line.rstrip())
            producer.flush()
    ...
    def consume(self):
        try:
            ...
            for message in consumer.consume_message():
                ...
                # employee_id,first_name,last_name,dept_id,salary,age,date_of_joining,emp_manager_name,date_of_birth
                ...
                populate_table = """
                    INSERT INTO {table_name} VALUES ({employee_id},'{first_name}','{last_name}','{dept_id}',{salary},{age},{date_of_joining},'{emp_manager_name}',{date_of_birth})
                    """
                ...
                populate_table_query = populate_table.format(table_name=table_name,
                                                             ...
                                                             age=message_items[3],
                                                             date_of_joining=message_items[4], emp_manager_name=message_items[5],employee_id=message_items[6],date_of_birth=message_items[7], dept_id=message_items[8])
