    ...
    def consume(self):
        try:
            ...
            for message in consumer.consume_message():
                ...
                populate_table = """
                                    INSERT INTO {table_name} VALUES ({employee_id},'{first_name}','{last_name}','{emp_manager_name}',{salary},{date_of_joining},{age},{date_of_birth},{dept_id})
                                    """
                ...
                populate_table_query = populate_table.format(table_name=table_name,
                                                             employee_id=message_items[0],
                                                             first_name=message_items[1],
                                                             last_name=message_items[2],
                                                             emp_manager_name=message_items[3],
                                                             salary=message_items[4],
                                                             date_of_joining=message_items[5],
                                                             age=message_items[6],
                                                             date_of_birth=message_items[7],
                                                             dept_id=message_items[8],
